...
//                 else
//                 {
//                     SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "Lookup name=" << name << "exists but type error:" << typeid(T).name()
//                                                      << "   real-type:" << s_datas[name]->getTypeName();
//                 }
//             }
