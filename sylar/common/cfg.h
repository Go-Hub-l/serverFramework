...
#define CFG_PATH    "/root/projects/CoroutineDFS/sylar/conf/cfg.json" //配置文件路径
 ...
 */
/* -------------------------------------------*/
extern int get_cfg_value(const char* profile, const char* tile, const char* key, char* value);
